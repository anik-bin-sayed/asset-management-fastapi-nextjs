                  ...
                  >
                    ...
                    <td className="px-4 py-4">
                      <div className="flex justify-end gap-2">
                        <button
                          type="button"
                          className="rounded-lg border border-gray-200 px-3 py-1.5 text-sm font-medium text-gray-600 transition hover:border-yellow-300 hover:bg-yellow-50 hover:text-yellow-700"
                        >
                          Edit
                        </button>
                        ...
                        >
                          {deleteCatId == category?.id ? "Deleting" : "Delete"}
                        </button>
                      </div>
                    </td>
                  </tr>
